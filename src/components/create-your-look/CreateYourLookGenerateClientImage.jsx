...
// function getLockedText({ planKey, isLogin }) {
...
// function getPlanHint({ planKey, activePlan }) {
//   if (planKey === 'visitor') {
...
//   const initialOutputFormat = activePlan.allowedFormats.includes(
//     DEFAULT_OUTPUT_FORMAT,
//   )
//     ? DEFAULT_OUTPUT_FORMAT
//     : activePlan.allowedFormats[0]

//   const initialPhotoQuality = activePlan.allowedQualities.includes(
//     DEFAULT_PHOTO_QUALITY,
//   )
//     ? DEFAULT_PHOTO_QUALITY
//     : activePlan.allowedQualities[0]
...
//   const [photoQuality, setPhotoQuality] = useState(initialPhotoQuality)

//   const [generatedFile, setGeneratedFile] = useState(null)

//   useEffect(() => {
//     if (!activePlan.allowedFormats.includes(outputFormat)) {
//       setOutputFormat(activePlan.allowedFormats[0])
//     }

//     if (!activePlan.allowedQualities.includes(photoQuality)) {
//       setPhotoQuality(activePlan.allowedQualities[0])
//     }
//   }, [activePlan, outputFormat, photoQuality])
...
//   const lockedText = getLockedText({ planKey, isLogin })
//   const planHint = getPlanHint({ planKey, activePlan })
...
//                   const isLocked = !activePlan.allowedFormats.includes(
//                     format.id,
//                   )
...
//                   const isLocked = !activePlan.allowedQualities.includes(
//                     quality.id,
//                   )
